package com.bezkoder.spring.jdbc.sqlserver.springbootjdbctemplatesqlserver.controller;
...
import com.bezkoder.spring.jdbc.sqlserver.springbootjdbctemplatesqlserver.repository.TutorialRepository;
...
public class TutorialController {
    ...
    public ResponseEntity<String> createTutorial(@ModelAttribute Tutorial tutorial) {
        try {
